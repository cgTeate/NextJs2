      ...
      {open && (
        ...
        >
          <div className="flex flex-col justify-center items-center h-[100%]">
            ...
            <button disabled className="w-full bg-red-600 text-white p-2 shadow-md hover:brightness-125 disabled:bg-gray-200 disabled:cursor-pointer-not-allowed disbaled:hover:brightness-100">Upload Post</button>
          </div>
        </Modal>
      )}
    </div>
